...
-- CreateEnum
CREATE TYPE "public"."SagaStatus" AS ENUM ('ONGOING', 'COMPLETED', 'HIATUS', 'UNKNOWN');
...
CREATE TABLE "public"."saga" (
    ...
    "slug" TEXT NOT NULL,
    "description" TEXT,
    "status" "public"."SagaStatus" NOT NULL DEFAULT 'ONGOING',
...
-- CreateTable
CREATE TABLE "public"."book_favorite" (
    "id" TEXT NOT NULL,
    "bookId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "book_sagaId_sagaOrder_idx" ON "public"."book"("sagaId", "sagaOrder");

-- CreateIndex
CREATE UNIQUE INDEX "uniq_saga_order" ON "public"."book"("sagaId", "sagaOrder");

-- CreateIndex
CREATE UNIQUE INDEX "saga_slug_key" ON "public"."saga"("slug");

-- CreateIndex
CREATE INDEX "saga_name_idx" ON "public"."saga"("name");

-- CreateIndex
CREATE INDEX "saga_slug_idx" ON "public"."saga"("slug");
...
-- CreateIndex
CREATE INDEX "book_favorite_userId_idx" ON "public"."book_favorite"("userId");

-- CreateIndex
CREATE INDEX "book_favorite_bookId_idx" ON "public"."book_favorite"("bookId");

-- CreateIndex
CREATE UNIQUE INDEX "book_favorite_bookId_userId_key" ON "public"."book_favorite"("bookId", "userId");
...
-- AddForeignKey
ALTER TABLE "public"."book" ADD CONSTRAINT "book_sagaId_fkey" FOREIGN KEY ("sagaId") REFERENCES "public"."saga"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."book_favorite" ADD CONSTRAINT "book_favorite_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "public"."book"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."book_favorite" ADD CONSTRAINT "book_favorite_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."user"("_id") ON DELETE CASCADE ON UPDATE CASCADE;
